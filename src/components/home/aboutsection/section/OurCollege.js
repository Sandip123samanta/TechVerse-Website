	...
	return (
		<>
			...
			>
				...
				<div className="w-screen flex justify-between items-center bg-orange-300">
					<section id="ourteam1" className="-rotate-90 bg-red-500">
						<h1
					...
					<section
						id="paragraph"
						className="text-center w-auto md:w-[20rem]"
					>
					...
					<section id="ourteam2" className="-rotate-90 bg-red-500">
						<h1
							className={`text-4xl md:text-8xl font-roboto font-extrabold ${styles.strokedtext}`}
						>
							COLLEGE
