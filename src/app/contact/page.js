      ...
      <section className='container'>  
        <section className='contact-container flex lg:flex-row flex-col z-[8] gap-4'>
          <div className="lg:w-1/2 w-full flex flex-col gap-3">
            <h3 className='text-white font-young text-2xl'>Contact Us</h3>
            <p className='text-white font-mono'>Fill up the form and our Team will get back to you within 24 hours. Or click the phone number below to make a call to <b className='text-red-600'>Priyashri Batabyal</b>(Student Convenor).</p>
            <div className='w-full flex items-center gap-2'>
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
                <circle cx="24" cy="24" r="20" fill="#2979ff"></circle>
                <circle cx="24" cy="19" r="4" fill="#2962ff"></circle>
                <path fill="#2962ff" d="M24,26c0,0-9,0-9,5.727C15,35,16.636,35,24,35s9,0,9-3.273C33,26,24,26,24,26z"></path>
                <circle cx="24" cy="18" r="4" fill="#fff"></circle>
                <path fill="#fff" d="M24,25c0,0-9,0-9,5.727C15,34,16.636,34,24,34s9,0,9-3.273C33,25,24,25,24,25z"></path>
              </svg>
              <a 
              className='text-white'
              href='tel:+91 9163096928'>+91 9163096928</a>
            </div>
            <div className='w-full flex gap-3 text-white font-mono decoration-none'>
              ...
              >Facebook</a>
              <a 
              className='text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'>Instagram</a>
            </div>
          </div>
          <div className='flex-1 min-w-[50%] flex flex-col'>
              ...
              >
                ...
                <button 
                type="submit" 
                className="px-5 py-2.5 text-sm justify-center font-medium text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                disabled={isLoading}
                onFocus={handleFocus}
                onBlur={handleBlur}
                >
