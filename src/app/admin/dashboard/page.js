...
const Dashboard = () => {
	...
	return (
		<div className="container h-screen w-screen font-roboto">
			<StarsCanvas />
			<h1 className="mt-20 flex justify-center items-center text-4xl md:text-6xl font-extrabold font-roboto mb-4">
				Admin Dashboard
			</h1>
